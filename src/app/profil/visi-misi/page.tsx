...
export default function VisiMisi() {
  ...
  return (
    <motion.section
      ...
      className="max-w-6xl mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-3 gap-8"
    >
      {/* Sidebar */}
      <aside className="order-2 md:order-1 md:col-span-1 space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center text-center">
          ...
          <div className="font-bold text-green-800 text-base">{pejabat.nama}</div>
      ...
      <div className="order-1 md:order-2 md:col-span-2">
        <h1 className="text-3xl md:text-4xl font-extrabold mb-6 text-green-800 tracking-tight uppercase text-center md:text-left">
          VISI & MISI DP3AP2KB SUMATERA BARAT
        </h1>
        <div className="bg-white rounded-xl shadow-md p-6 md:p-10">
          <h2 className="text-xl font-bold mb-2 text-green-700">Visi</h2>
          ...
          <blockquote className="italic font-semibold text-lg text-green-900 bg-green-50 border-l-4 border-green-400 pl-4 py-2 mb-6 rounded">
            “TERWUJUDNYA SUMATERA BARAT MADANI<br />YANG UNGGUL DAN BERKELANJUTAN”
          </blockquote>
          <h2 className="text-xl font-bold mb-2 text-green-700">Misi</h2>
          <div className="mb-4 text-gray-700 leading-relaxed">
        ...
        <div className="mt-10">
          <h3 className="text-lg font-bold mb-4 text-green-700 flex items-center gap-2">
            <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 7V6a2 2 0 012-2h2.172a2 2 0 011.414.586l1.828 1.828A2 2 0 0012.828 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z" /></svg>
            Galeri Kegiatan
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {galleryImages.map((img) => (
              <button
                key={img.src}
                className="group relative rounded-lg overflow-hidden shadow hover:shadow-lg transition-all border border-gray-100 hover:border-green-400 focus:outline-none"
